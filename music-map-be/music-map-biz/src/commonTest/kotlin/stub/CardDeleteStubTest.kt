...
class CardDeleteStubTest {
    ...
    fun delete() = runTest {
        ...
        val stub = CardStub.get()
        assertEquals(stub.id, ctx.cardResponse.id)
        assertEquals(stub.title, ctx.cardResponse.title)
        assertEquals(stub.description, ctx.cardResponse.description)
        assertEquals(stub.visibility, ctx.cardResponse.visibility)
    }
